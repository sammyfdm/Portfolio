...
//    static long update;
    ...
    public static void check2 (int i1, int i2, int pos)
    {
        ...
        if (!inside)
            check3 (i1, i2, z - 1,pos);
        else
            radius = Math.sqrt (radius); //avoids sqrt in above calculations
    }


    public static void check3 (int i1, int i2, int i3, int pos)
    {
    ...
    public static void recursion (int pos, double a)
    {
        for (int k = 1 ; k < N ; k++)
        {
            sequence [pos - 1] = k;
