...
#**essential:
	-change control flow; when taking cards; signal
...
class SandM(Frame):
	...
	#this function takes care of dealing with client when it's their turn
...
root = Tk()
Game = SandM(master=root,sock=conn)
Game.master.title("Player 2 - Server")
Game.mainloop()
root.destroy()
